...
- (void)createButton{
    ...
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
            ...
            [button setBackgroundImage:[UIImage imageNamed:@"time_icon_gray"] forState:UIControlStateNormal];
            [button setBackgroundImage:[UIImage imageNamed:@"time_icon_normal"] forState:UIControlStateSelected];
